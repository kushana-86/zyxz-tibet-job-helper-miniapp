...
const { ONLINE_COUNTY_DATA } = require("./county-online-data");
...
const buildProfile = (name) => {
  ...
  const onlineData = ONLINE_COUNTY_DATA[name] || null;
  ...
  return {
    ...
    onlineDescription: onlineData ? onlineData.description || "" : "",
    parentRegion: onlineData ? onlineData.parent || "" : "",
    population: onlineData ? onlineData.population || null : null,
    populationAsOf: onlineData ? onlineData.populationAsOf || "" : "",
    areaKm2: onlineData ? onlineData.areaKm2 || null : null,
    postalCode: onlineData ? onlineData.postalCode || "" : "",
    officialWebsite: onlineData ? onlineData.officialWebsite || "" : "",
    coordinates: onlineData ? onlineData.coordinates || null : null,
    sourceUrl: onlineData ? onlineData.sourceUrl || "" : "",
    wikidataId: onlineData ? onlineData.wikidataId || "" : "",
    jobInfo,
    riskFlags,
